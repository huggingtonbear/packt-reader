...
maptAlert = function (message, type) {
    ...
    $('#wrapper').append('<div id="' + id + '" class="packt-message alert alert-' + type + ' alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><span>' + message + '</span></div>');
    setTimeout(function () {
